...
xgb = discriminant_analysis.LinearDiscriminantAnalysis()
...
results.to_csv('FisherLDA-random-grid-search-results-01.csv', index=False)
ax = random_search.best_estimator_
ax.fit(X_train,y_train)

dump(ax, 'FisherLDA.joblib')
