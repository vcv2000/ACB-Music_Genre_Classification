...
params = {
        'alpha':[0.000100, 0.000200, 0.000300, 0.00050],
    'max_iter':[1000, 2000, 1500, 3000],
    'penalty':['l2', 'l1', 'elasticnet', None],
    'learning_rate':["optimal",'constant','invscaling','adaptive'],
        }
y_train = y_train.astype(float)
X_train = X_train.astype(float)
xgb = SGDClassifier(eta0=1)
...
results.to_csv('SGD-random-grid-search-results-01.csv', index=False)
